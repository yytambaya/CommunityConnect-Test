...
const Profile4 = () => {
  ...
  return (
    <div className="w-full h-[960px] relative bg-generic-white overflow-hidden leading-[normal] tracking-[normal] text-left text-base text-primary-800 font-paragraph-medium-medium mq1150:h-auto mq1150:min-h-[960]">
      <img
      ...
      <div className="absolute top-[144px] left-[355px] rounded-tl-md rounded-tr-none rounded-br-none rounded-bl-md bg-generic-white box-border w-[212px] overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[504px] border-[1px] border-solid border-neutral-100">
        <div className="self-stretch bg-primary-500 overflow-hidden flex flex-col items-start justify-start py-3.5 pr-5 pl-[66px] gap-[16px] text-9xl text-generic-white">
          <button className="cursor-pointer [border:none] py-1 px-[11px] bg-primary-50 rounded-3xl flex flex-row items-start justify-start whitespace-nowrap hover:bg-thistle-100">
        ...
        <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-4 gap-[23px]">
          <img
      ...
      <div className="absolute top-[144px] left-[567px] bg-generic-white box-border w-[212px] h-[774px] overflow-hidden flex flex-col items-start justify-start pt-3.5 px-0 pb-6 gap-[114px] border-t-[1px] border-solid border-neutral-100 border-r-[1px] border-b-[1px]">
        <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[14px]">
          <div className="flex flex-row items-start justify-start py-0 pr-[59px] pl-[57px]">
          ...
          <div className="flex flex-row items-start justify-start py-0 px-[57px] text-9xl text-primary-500">
