...
const Events1 = () => {
  ...
  return (
    <div className="w-full h-[960px] relative bg-generic-white overflow-hidden leading-[normal] tracking-[normal] text-left text-lg text-neutral-900 font-paragraph-medium-medium mq725:h-auto mq725:min-h-[960]">
      <img
