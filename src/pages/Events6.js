const Events = () => {
  return (
    <div className="w-full h-[960px] relative bg-generic-white overflow-hidden leading-[normal] tracking-[normal] text-left text-base text-primary-900 font-paragraph-medium-medium mq725:h-auto mq725:min-h-[960]">
      <img
        className="absolute top-[0px] left-[0px] w-[1440px] h-[990px] object-cover hidden"
        alt=""
        src="/image-3@2x.png"
      />
      <div className="absolute top-[0px] left-[0px] box-border w-[331px] overflow-hidden flex flex-col items-start justify-start pt-[26px] px-[50px] pb-[535px] gap-[31px] text-neutral-500 border-r-[1px] border-solid border-neutral-300">
      ...
      <div className="absolute top-[56px] left-[331px] w-[674px] overflow-hidden flex flex-col items-start justify-start pt-4 pb-0 pr-0 pl-4 box-border gap-[24px] max-w-full text-lg">
        <div className="flex flex-row items-start justify-start gap-[16px] max-w-[114%] shrink-0 mq725:flex-wrap">
          ...
          <button className="cursor-pointer py-1.5 px-[19px] bg-[transparent] w-[79px] rounded-xl box-border flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
        ...
        <div className="w-[968px] flex flex-col items-start justify-start gap-[16px] max-w-[148%] shrink-0">
          ...
          <div className="w-[678px] overflow-x-auto flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[16px] max-w-full text-sm">
            ...
            <div className="w-[230px] rounded-md bg-generic-white shrink-0 flex flex-col items-start justify-start">
              <img
                className="[border:none] bg-[transparent] [outline:none] self-stretch h-[140px] relative rounded-t-md rounded-b-none max-w-full overflow-hidden shrink-0 object-cover"
                alt=""
                src="/frame-127-7@2x.png"
              />
        ...
        <div className="w-[968px] flex flex-col items-start justify-start gap-[16px] max-w-[148%] shrink-0">
          ...
          <div className="w-[678px] h-[84px] overflow-x-auto shrink-0 flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[16px] max-w-full text-sm">
            <div className="h-[282px] w-[230px] rounded-md bg-generic-white shrink-0 flex flex-col items-start justify-start">
              <img
                className="self-stretch flex-1 relative rounded-t-md rounded-b-none max-w-full overflow-hidden max-h-full object-cover"
                alt=""
      ...
      <div className="absolute top-[0px] right-[0px] box-border overflow-hidden flex flex-col items-start justify-start pt-[77px] pb-[420px] pr-0 pl-[23px] gap-[30.5px] max-w-full text-sm border-l-[1px] border-solid border-neutral-300">
        <div className="h-[182.5px] flex flex-col items-start justify-start gap-[16px] max-w-full">
          <div className="relative leading-[20px] font-medium">
            Explore event happening at different locations
          </div>
          <div className="w-[411px] flex-1 overflow-x-auto flex flex-row items-start justify-start gap-[12px] max-w-full text-5xl text-generic-white">
            <div className="overflow-hidden shrink-0 flex flex-row items-start justify-start py-[57px] px-[45px] bg-[url('/public/value-transformer@3x.png')] bg-cover bg-no-repeat bg-[top] [debug_commit:1de1738]">
              <h2 className="m-0 relative text-inherit tracking-[-0.02em] leading-[32px] font-semibold font-inherit inline-block min-w-[88px] mq450:text-lgi mq450:leading-[26px]">
                Toronto
              </h2>
            </div>
            <div className="overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[57px] pb-[57.5px] pr-[46.7px] pl-[47px] bg-[url('/public/input-splitter@3x.png')] bg-cover bg-no-repeat bg-[top] [debug_commit:1de1738]">
              <h2 className="m-0 relative text-inherit tracking-[-0.02em] leading-[32px] font-semibold font-inherit inline-block min-w-[85px] mq450:text-lgi mq450:leading-[26px]">
                London
              </h2>
            </div>
        ...
        <div className="w-[386px] flex flex-row items-start justify-start py-0 px-1 box-border max-w-full text-neutral-700">
