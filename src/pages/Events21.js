...
const Events2 = () => {
  ...
  return (
    <div className="w-full h-[960px] relative bg-generic-white overflow-hidden leading-[normal] tracking-[normal] text-left text-lg text-neutral-900 font-paragraph-medium-medium mq750:h-auto mq750:min-h-[960]">
      <img
      ...
      <div className="absolute top-[56px] left-[331px] w-[674px] overflow-hidden flex flex-col items-start justify-start pt-4 px-4 pb-0 box-border gap-[24px] max-w-full text-primary-900">
        <div className="flex flex-row items-start justify-start gap-[16px] max-w-[117%] shrink-0 mq750:flex-wrap">
          <button
            className="cursor-pointer py-1.5 px-[19px] bg-[transparent] w-[55px] rounded-xl box-border flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100"
            onClick={onFrameButtonClick}
          >
            <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-primary-900 text-left inline-block min-w-[15px]">
              All
            </div>
          </button>
          <button className="cursor-pointer [border:none] py-2 px-5 bg-primary-500 rounded-xl flex flex-row items-start justify-start hover:bg-slateblue">
            <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-generic-white text-left inline-block min-w-[39px]">
              Sports
            </div>
          </button>
        ...
        <div className="w-[212px] flex flex-col items-start justify-center py-0 pr-5 pl-0 box-border gap-[14px] text-base text-neutral-800">
          ...
          <div className="self-stretch flex flex-row items-center justify-start gap-[24px] text-9xl text-black">
            <h1 className="m-0 relative text-inherit tracking-[-0.02em] leading-[36px] font-medium font-inherit inline-block min-w-[87px] mq450:text-3xl mq450:leading-[29px]">
              Sports
            </h1>
            <button className="cursor-pointer py-[3px] px-[21px] bg-primary-50 flex-1 rounded-md flex flex-row items-center justify-start border-[1px] border-solid border-primary-100 hover:bg-thistle-100 hover:box-border hover:border-[1px] hover:border-solid hover:border-thistle-200">
        ...
        <div className="w-[658px] overflow-x-auto flex flex-row items-start justify-start gap-[16px] max-w-[103%] shrink-0 text-sm">
          ...
          <div className="h-[282px] w-[230px] rounded-md bg-generic-white shrink-0 flex flex-col items-start justify-start text-xs">
            <img
              className="[border:none] bg-[transparent] h-[140px] w-auto [outline:none] self-stretch relative rounded-t-md rounded-b-none max-w-full overflow-hidden shrink-0 object-cover"
              rows={7}
              cols={12}
              alt=""
              src="/frame-127-7@2x.png"
            />
            <div className="self-stretch flex-1 rounded-t-none rounded-b-md bg-generic-white overflow-hidden flex flex-col items-start justify-start pt-2 px-0 pb-0 gap-[10px]">
        ...
        <div className="w-[722px] flex flex-col items-start justify-start gap-[16px] max-w-[113%] shrink-0">
        ...
        <div className="w-[722px] flex flex-col items-start justify-start gap-[16px] max-w-[113%] shrink-0">
          ...
          <div className="self-stretch h-[30px] flex flex-row items-start justify-start pt-0 px-0 pb-0 box-border gap-[16px] text-sm">
            <div className="h-[282px] flex-1 rounded-md bg-generic-white flex flex-col items-start justify-start">
              <img
                className="self-stretch flex-1 relative rounded-t-md rounded-b-none max-w-full overflow-hidden max-h-full object-cover"
                loading="lazy"
                alt=""
                src="/frame-127-72@2x.png"
              />
              <div className="self-stretch h-[142px] rounded-t-none rounded-b-md bg-generic-white overflow-hidden shrink-0 flex flex-col items-start justify-start pt-2 px-0 pb-[38px] box-border gap-[4px]">
            ...
            <div className="h-[262px] flex-1 rounded-md bg-generic-white flex flex-col items-start justify-start">
              <img
                className="self-stretch flex-1 relative rounded-t-md rounded-b-none max-w-full overflow-hidden max-h-full object-cover"
                loading="lazy"
                alt=""
                src="/frame-127-82@2x.png"
              />
            ...
            <div className="h-[282px] flex-1 rounded-md bg-generic-white flex flex-col items-start justify-start text-xs">
              <img
                className="self-stretch flex-1 relative rounded-t-md rounded-b-none max-w-full overflow-hidden max-h-full object-cover"
                alt=""
                src="/frame-127-92@2x.png"
              />
        ...
        <div className="self-stretch overflow-hidden flex flex-row items-start justify-start pt-3 px-6 pb-2.5 gap-[20px] border-b-[1px] border-solid border-neutral-300 mq450:flex-wrap">
          <div className="w-[286px] rounded-md box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-1 px-3 gap-[82px] border-[1px] border-solid border-neutral-300">
            ...
            <div className="flex flex-row items-start justify-start gap-[5.5px]">
              ...
              <div className="flex flex-col items-start justify-start pt-px px-0 pb-0">
                <input
                  className="border-white accent-white cursor-pointer m-0 w-[18px] h-[18px] relative overflow-hidden shrink-0"
                  checked={true}
                  type="radio"
                  name="radioGroup-2"
                />
      ...
      <header className="absolute top-[0px] left-[calc(50%_-_720px)] bg-primary-700 w-full overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border max-w-full z-[2] text-left text-sm text-neutral-600 font-paragraph-medium-medium mq750:pl-[25px] mq750:box-border">
