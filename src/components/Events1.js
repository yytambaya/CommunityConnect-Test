...
const Events = () => {
  return (
    <form className="m-0 w-[1440px] h-[960px] bg-generic-white max-w-full overflow-hidden leading-[normal] tracking-[normal] mq725:h-auto mq725:min-h-[960]">
      <img
      ...
      <div className="absolute top-[56px] left-[331px] w-[674px] overflow-hidden flex flex-col items-start justify-start pt-[9px] pb-0 pr-0 pl-4 box-border gap-[21px] max-w-full">
        <div className="rounded-xl hidden flex-row items-center justify-center py-1.5 px-[19px] whitespace-nowrap border-[1px] border-solid border-neutral-300">
        ...
        <div className="w-[799px] flex flex-row flex-wrap items-end justify-start gap-[4px] max-w-[122%] shrink-0">
          <div className="flex flex-col items-start justify-end pt-0 pb-px pr-3 pl-0">
          ...
          <div className="w-[97px] flex flex-col items-start justify-end pt-0 pb-px pr-3 pl-0 box-border">
            <button className="cursor-pointer py-1.5 px-[19px] bg-[transparent] self-stretch rounded-xl flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
          ...
          <div className="w-20 flex flex-col items-start justify-end pt-0 px-0 pb-px box-border">
            <button className="cursor-pointer py-1.5 px-[19px] bg-[transparent] self-stretch rounded-xl flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
          ...
          <div className="h-11 flex-1 relative min-w-[165px]">
            <button className="cursor-pointer py-1.5 px-[19px] bg-[transparent] absolute top-[7px] left-[153px] rounded-xl box-border w-[89px] flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
            ...
            <div className="absolute top-[0px] left-[0px] rounded-md bg-secondary-100 flex flex-row items-start justify-start py-3 px-6 whitespace-nowrap z-[1]">
              <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-primary-900 text-center">
                Your request has been received
              </div>
            </div>
          </div>
          <div className="w-[95px] flex flex-col items-start justify-end pt-0 pb-px pr-3 pl-0 box-border">
            <button className="cursor-pointer py-1.5 px-[19px] bg-[transparent] self-stretch rounded-xl flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
          ...
          <div className="w-[107px] flex flex-col items-start justify-end pt-0 pb-px pr-3 pl-0 box-border">
            <div className="self-stretch rounded-xl flex flex-row items-start justify-start py-1.5 px-[19px] border-[1px] border-solid border-neutral-300">
          ...
          <div className="w-[73px] flex flex-col items-start justify-end pt-0 px-0 pb-px box-border">
            <button className="cursor-pointer py-2 px-[19px] bg-[transparent] self-stretch h-9 rounded-xl box-border flex flex-row items-start justify-start border-[1px] border-solid border-neutral-300 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
        ...
        <div className="w-[968px] flex flex-col items-start justify-start gap-[16px] max-w-[148%] shrink-0">
          ...
          <div className="w-[678px] overflow-x-auto flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[16px] max-w-full">
            <Component1
              parallelProcessor="/frame-127@2x.png"
              frame="/frame-3.svg"
            />
            ...
            <Component1
              parallelProcessor="/frame-127-2@2x.png"
              frame="pending_I521:3238;200:1664"
            />
            <div className="h-[282px] w-[230px] rounded-md bg-generic-white shrink-0 flex flex-col items-start justify-start">
              <img
                className="self-stretch flex-1 relative rounded-t-md rounded-b-none max-w-full overflow-hidden max-h-full object-cover"
        ...
        <div className="w-[968px] flex flex-col items-start justify-start gap-[16px] max-w-[148%] shrink-0">
          ...
          <div className="w-[678px] overflow-x-auto flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[16px] max-w-full">
            ...
            <Component
              frame127="/frame-127-7@2x.png"
              frame="pending_I521:3246;200:1664"
            />
          </div>
        </div>
        <div className="w-[968px] flex flex-col items-start justify-start gap-[16px] max-w-[148%] shrink-0">
          ...
          <div className="w-[678px] h-20 overflow-x-auto shrink-0 flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[16px] max-w-full">
            ...
            <Component
              frame127="/frame-127-11@2x.png"
              frame="pending_I521:3253;200:1664"
            />
          </div>
        </div>
      </div>
      ...
      <header className="absolute top-[0px] left-[calc(50%_-_720px)] bg-primary-700 w-full overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border max-w-full z-[1] mq725:pl-[25px] mq725:box-border">
