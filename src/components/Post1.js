const Post1 = () => {
  return (
    <form className="m-0 w-[1440px] h-[960px] bg-generic-white max-w-full overflow-hidden leading-[normal] tracking-[normal] mq450:h-auto mq450:min-h-[960]">
      <img
          ...
          <div className="flex flex-col items-start justify-start gap-[30px]">
            ...
            <div className="flex flex-row items-center justify-start gap-[16px]">
              <img
                ...
                loading="lazy"
                alt=""
                src="/explore-svgrepocom6.svg"
              />
              <div className="relative text-base leading-[24px] font-medium font-paragraph-medium-medium text-primary-500 text-left inline-block min-w-[58px]">
                Explore
              </div>
            </div>
            <div className="flex flex-row items-center justify-start gap-[16px]">
      ...
      <div className="absolute top-[56px] left-[331px] w-[674px] h-[904px] overflow-hidden flex flex-col items-start justify-start pt-4 px-0 pb-0 box-border gap-[16px] max-w-full mq450:h-auto">
        <img
          className="self-stretch relative max-w-full overflow-hidden max-h-full hidden"
          alt=""
        />
        <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-1 box-border gap-[12px] shrink-0 [debug_commit:1de1738] max-w-full">
          <div className="self-stretch flex flex-row items-start justify-start pt-0 pb-1 pr-[27px] pl-[26px] box-border max-w-full">
            <div className="flex-1 flex flex-col items-start justify-start gap-[8px] max-w-full">
              <div className="self-stretch rounded-7xl overflow-hidden flex flex-row items-start justify-start py-[7px] px-3 gap-[8px] border-[1px] border-solid border-neutral-300 mq450:flex-wrap">
                <img
                ...
                <div className="flex flex-col items-start justify-start pt-[5px] px-0 pb-0">
                  <div className="relative text-sm leading-[20px] font-paragraph-medium-medium text-neutral-600 text-left">
                    Share your experience
                  </div>
                </div>
              </div>
              <div className="rounded-md flex flex-row items-start justify-start py-1.5 px-[11px] gap-[8px] whitespace-nowrap border-[1px] border-solid border-neutral-300">
                <div className="relative text-sm leading-[20px] font-paragraph-medium-medium text-neutral-800 text-left inline-block min-w-[118px]">
                  select event code
                </div>
                <img
          ...
          <div className="self-stretch flex flex-row items-start justify-start pt-0 pb-1 pr-[27px] pl-[26px] box-border max-w-full">
            <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-[20px] mq450:flex-wrap">
              <div className="flex flex-col items-start justify-start pt-px px-0 pb-0">
                <img
                  className="w-[30px] h-[30px] relative rounded-81xl overflow-hidden shrink-0"
                  loading="lazy"
                  alt=""
                  src="/frame-166.svg"
                />
              </div>
              <button className="cursor-pointer [border:none] py-1.5 px-[22px] bg-primary-500 rounded-md flex flex-row items-start justify-start hover:bg-slateblue">
                <div className="relative text-xs leading-[20px] font-semibold font-paragraph-medium-medium text-gray-300 text-left inline-block min-w-[27px]">
                  Post
                </div>
              </button>
            </div>
          ...
          <div className="flex flex-row items-start justify-start pt-0 px-[26px] pb-1">
            <div className="flex flex-row items-start justify-start gap-[8px]">
              ...
              <div className="flex flex-col items-start justify-start">
                <div className="relative text-base leading-[24px] font-medium font-paragraph-medium-medium text-primary-900 text-left inline-block min-w-[104px]">
                  Khairat Adam
                </div>
                <div className="flex flex-row items-start justify-start gap-[6px]">
                  <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-neutral-600 text-left inline-block min-w-[44px]">
                    2hr ago
                  </div>
                  <div className="flex flex-col items-start justify-start pt-2 px-0 pb-0">
                    <div className="w-1 h-1 relative rounded-xl bg-primary-900 overflow-hidden shrink-0" />
                  </div>
                  <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-secondary-500 text-left inline-block min-w-[53px]">
                    #SDS123
                  </div>
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-end pt-0 px-[58px] pb-1 box-border max-w-full shrink-0">
            <div className="w-[542px] relative text-base leading-[24px] font-paragraph-medium-medium text-black text-left inline-block shrink-0 max-w-full">
          ...
          <div className="self-stretch flex flex-row items-start justify-end pt-0 px-[58px] pb-1 box-border max-w-full">
            <div className="w-[545px] flex flex-row items-start justify-between gap-[20px] max-w-full mq450:flex-wrap">
              <div className="flex flex-row items-start justify-start gap-[8px]">
                ...
                <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
                  <div className="relative text-xs leading-[20px] font-paragraph-medium-medium text-primary-900 text-left inline-block min-w-[13px]">
                    15
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-row items-start justify-start pt-0 px-[29px] pb-1">
            <div className="flex flex-row items-start justify-start gap-[8px]">
              <img
                className="h-10 w-10 relative rounded-[65.96px] overflow-hidden shrink-0 object-cover"
                alt=""
              ...
              />
              <div className="flex flex-col items-start justify-start">
                <div className="relative text-base leading-[24px] font-medium font-paragraph-medium-medium text-primary-900 text-left inline-block min-w-[100px]">
                  Jessica John
                </div>
                <div className="flex flex-row items-start justify-start gap-[6px]">
                  <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-neutral-600 text-left inline-block min-w-[44px] z-[1]">
                    2hr ago
                  </div>
                  <div className="flex flex-col items-start justify-start pt-2 px-0 pb-0">
                    <div className="w-1 h-1 relative rounded-xl bg-primary-900 overflow-hidden shrink-0" />
                  </div>
                  <div className="relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-secondary-500 text-left inline-block min-w-[53px] z-[1]">
                    #SDS123
                  </div>
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-end py-0 px-[59px] box-border max-w-full shrink-0">
            <div className="w-[542px] relative text-base leading-[24px] font-paragraph-medium-medium text-black text-left inline-block shrink-0 max-w-full">
          ...
          <div className="self-stretch flex flex-row items-start justify-end pt-0 px-[59px] pb-1 box-border max-w-full">
            <img
          ...
          <div className="self-stretch flex flex-row items-start justify-end py-0 px-[59px] box-border max-w-full">
            <div className="w-[542px] flex flex-row items-start justify-between gap-[20px] max-w-full mq450:flex-wrap">
              <div className="h-0.5 flex flex-row items-start justify-start pt-0 px-0 pb-0 box-border gap-[8px]">
                <img
                  className="h-6 w-6 relative overflow-hidden shrink-0"
                  alt=""
                />
                <div className="h-0.5 w-[13px] flex flex-col items-start justify-start pt-0.5 px-0 pb-0 box-border">
                  <div className="self-stretch h-5 relative text-xs leading-[20px] font-paragraph-medium-medium text-primary-900 text-left inline-block">
                    15
                  </div>
                </div>
              </div>
        ...
        <div className="self-stretch h-0 flex flex-col items-start justify-start shrink-0 [debug_commit:1de1738]">
          <img
            className="self-stretch relative max-w-full overflow-clip max-h-[unset]"
            alt=""
          />
          <img
            className="self-stretch relative max-w-full overflow-clip max-h-[unset] z-[1]"
            alt=""
          />
        </div>
        <img
          ...
          alt=""
        />
        <div className="self-stretch flex flex-col items-start justify-start gap-[12px] shrink-0 [debug_commit:1de1738] max-w-full">
          <div className="w-[213px] h-12 flex flex-row items-start justify-start pt-0 px-[26px] pb-1 box-border">
            <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[8px]">
              ...
              <div className="self-stretch flex-1 flex flex-col items-start justify-start">
                <div className="w-[104px] h-6 relative text-base leading-[24px] font-medium font-paragraph-medium-medium text-primary-900 text-left inline-block">
                  Khairat Adam
                </div>
                <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[6px]">
                  <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[6px]">
                    <div className="self-stretch flex-1 relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-neutral-600 text-left z-[1]">
                      2hr ago
                    </div>
                    <div className="flex flex-col items-start justify-start pt-2 px-0 pb-0">
                      <div className="w-1 h-1 relative rounded-xl bg-primary-900 overflow-hidden shrink-0" />
                  ...
                  <div className="self-stretch flex-1 relative text-xs leading-[20px] font-medium font-paragraph-medium-medium text-secondary-500 text-left z-[1]">
                    #SDS123
                  </div>
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-end pt-0 px-[58px] pb-1 box-border max-w-full">
            <div className="h-[120px] w-[542px] relative text-base leading-[24px] font-paragraph-medium-medium text-black text-left inline-block shrink-0 max-w-full">
              Surrounded by laughter, good food, and the warmth of friendship,
              today's Ladies Picnic Event was pure bliss! From delightful
              conversations to the serene backdrop of nature, every moment was a
              treasure. Here's to making memories that last a lifetime!
          ...
          <div className="w-[219px] h-12 flex flex-row items-start justify-start pt-0 px-[29px] pb-1 box-border">
            <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[8px]">
              <img
                className="h-10 w-10 relative rounded-[65.96px] overflow-hidden shrink-0 object-cover"
                alt=""
              ...
              />
              <div className="self-stretch flex-1 flex flex-col items-start justify-start">
                <div className="w-[100px] h-6 relative text-base leading-[24px] font-medium font-paragraph-medium-medium text-primary-900 text-left inline-block">
                  Jessica John
                </div>
                <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[6px]">
                  <div className="self-stretch flex-1 flex flex-row items-start justify-start gap-[6px]">
          ...
          <div className="self-stretch flex flex-row items-start justify-end py-0 px-[59px] box-border max-w-full">
            <div className="h-[72px] w-[542px] relative text-base leading-[24px] font-paragraph-medium-medium text-black text-left inline-block shrink-0 max-w-full">
              "Today's Tech Expo was a whirlwind of innovation, from
              mind-bending AI to game-changing gadgets - feeling energized and
              excited about the future of tech!"
            </div>
      ...
      <div className="absolute top-[0px] right-[0px] box-border w-[435px] overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[625px] gap-[29px] max-w-full border-l-[1px] border-solid border-neutral-300">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[33px] pl-6 box-border max-w-full">
      ...
      <div className="absolute top-[0px] left-[330px] box-border w-[675px] h-14 overflow-hidden hidden border-b-[1px] border-solid border-neutral-300">
        <div className="absolute top-[14px] left-[25px] text-lg leading-[28px] font-medium font-paragraph-medium-medium text-black text-left inline-block min-w-[73px]">
          Timeline
        </div>
      </div>
      <header className="absolute top-[0px] left-[calc(50%_-_720px)] bg-primary-700 w-full overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border max-w-full z-[2] mq725:pl-[25px] mq725:box-border">
