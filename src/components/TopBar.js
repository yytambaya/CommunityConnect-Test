...
const TopBar = () => {
  ...
  return (
    <div className="sticky top-[0] left-[calc(50%_-_720px)] bg-primary-700 w-full flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border z-[99] max-w-full text-left text-sm text-neutral-600 font-paragraph-medium-medium mq725:pl-[25px] mq725:box-border">
      ...
      <header className="flex-1 bg-primary-700 box-border overflow-hidden flex flex-row items-start justify-start py-[13px] px-6 max-w-full text-left text-base text-generic-white font-paragraph-medium-medium border-r-[1px] border-solid border-primary-600 border-l-[1px]">
        <div
        ...
        >
          ...
          <div className="flex flex-col items-start justify-start pt-[3px] px-0 pb-0">
            <div className="relative leading-[24px] font-medium">Post</div>
          </div>
        </div>
      </header>
      <div className="w-[435px] bg-primary-700 overflow-hidden shrink-0 flex flex-row items-start justify-start py-3 px-6 box-border gap-[20px] max-w-full">
        <div className="w-[286px] rounded-md bg-generic-white overflow-hidden shrink-0 flex flex-row items-start justify-start pt-1.5 px-3 pb-[5.5px] box-border gap-[82px]">
          <div className="flex flex-row items-start justify-start gap-[4px]">
            ...
            <div className="relative leading-[20px] whitespace-nowrap">{`Search `}</div>
          </div>
          <div className="flex flex-row items-start justify-start gap-[7px]">
            ...
            <div className="flex flex-row items-start justify-start gap-[4px]">
              ...
              <div className="relative leading-[20px]">Abuja</div>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-start justify-start pt-px px-0 pb-0">
