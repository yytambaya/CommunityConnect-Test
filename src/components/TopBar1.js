const TopBar = () => {
  return (
    <header className="self-stretch bg-primary-700 overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border top-[0] z-[99] sticky max-w-full text-left text-lg text-generic-white font-paragraph-medium-medium mq750:pl-[25px] mq750:box-border">
