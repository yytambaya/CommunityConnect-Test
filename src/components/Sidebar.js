    ...
    return(
        ...
        <div className="flex flex-col items-start justify-start gap-[40px] text-base text-neutral-500">
          <div className="flex flex-col items-start justify-start gap-[30px]">
            <div onClick={() => navigate('/app/events')}  className="cursor-pointer flex flex-row items-center justify-start gap-[16px] text-primary-500">
              <img
            ...
            <div onClick={() => navigate('/app/events')}  className="cursor-pointer flex flex-row items-center justify-start gap-[16px]">
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                loading="lazy"
                alt=""
            ...
            <div onClick={() => navigate('/app/community')} className="cursor-pointer flex flex-row items-center justify-start gap-[16px]">
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                alt=""
                src="/frame-11.svg"
            ...
            <div onClick={() => navigate('/app/profile')} className="cursor-pointer flex flex-row items-center justify-start gap-[16px]">
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                alt=""
                src="/frame-2.svg"
          ...
          <div className="flex flex-col items-start justify-start gap-[24px]">
            ...
            <button onClick={() => navigate('/app/create-community')} className="cursor-pointer py-2 px-[15px] bg-[transparent] rounded-md flex flex-row items-center justify-center whitespace-nowrap border-[1px] border-solid border-neutral-300 hover:bg-silver-200 hover:box-border hover:border-[1px] hover:border-solid hover:border-silver-100">
