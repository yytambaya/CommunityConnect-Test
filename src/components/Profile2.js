  ...
  return (
    <form className="m-0 w-[1440px] h-[960px] bg-generic-white max-w-full overflow-hidden leading-[normal] tracking-[normal]">
      ...
      <div className="absolute top-[118px] left-[814px] flex flex-col items-center justify-start gap-[10px]">
        ...
        />
        <div className="flex flex-col items-center justify-start py-0 px-0.5 gap-[8px]">
          ...
          <button className="cursor-pointer py-0.5 px-2.5 bg-primary-50 rounded-3xl flex flex-row items-center justify-start whitespace-nowrap border-[1px] border-solid border-neutral-200 hover:bg-thistle-100 hover:box-border hover:border-[1px] hover:border-solid hover:border-lightgray-200">
            <div className="relative text-lg leading-[28px] font-medium font-paragraph-medium-medium text-primary-500 text-left inline-block min-w-[113px]">
              Basic Mentor
            </div>
          </button>
        </div>
      ...
      <header className="absolute top-[0px] left-[calc(50%_-_720px)] bg-primary-700 w-full overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border max-w-full z-[2] mq725:pl-[25px] mq725:box-border">
        ...
        <div className="flex-1 bg-primary-700 box-border overflow-hidden flex flex-row items-start justify-start py-3.5 px-[25px] max-w-full border-r-[1px] border-solid border-primary-600 border-l-[1px]">
          <input
            className="w-14 [border:none] [outline:none] font-medium font-paragraph-medium-medium text-lg bg-[transparent] h-7 relative leading-[28px] text-generic-white text-left inline-block p-0"
            placeholder="Profile"
            type="text"
          />
        </div>
