const FrameComponent1 = () => {
  return (
    <div className="w-[476px] flex flex-col items-start justify-start pt-0 px-0 pb-2 box-border gap-[16px] shrink-0 [debug_commit:1de1738] max-w-full text-left text-lg text-primary-900 font-paragraph-medium-medium">
      <div className="flex flex-row items-start justify-start gap-[32px] text-gray-100">
        <button className="cursor-pointer [border:none] pt-2 px-2 pb-1 bg-[transparent] flex flex-row items-start justify-start border-b-[3px] border-solid border-primary-500">
          <div className="relative text-lg leading-[28px] font-paragraph-medium-medium text-primary-500 text-left inline-block min-w-[79px]">
            Activities
          </div>
        </button>
        <div className="flex flex-col items-start justify-start pt-2 px-0 pb-0">
          <div className="relative leading-[28px] inline-block min-w-[80px]">
            Members
          </div>
        </div>
      </div>
      ...
      <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[16px] text-sm">
        <div className="flex-1 rounded-md bg-generic-white flex flex-col items-start justify-start min-w-[149px]">
          <img
