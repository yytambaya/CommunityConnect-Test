...
const TopBar1 = () => {
  ...
  return (
    <div className="self-stretch bg-primary-700 overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[50px] box-border [row-gap:20px] max-w-full z-[1] text-left text-base text-generic-white font-paragraph-medium-medium mq1150:flex-wrap mq1150:pl-5 mq1150:pr-5 mq1150:pb-5 mq1150:box-border">
      ...
      <div className="flex-1 bg-primary-700 box-border overflow-hidden flex flex-row items-start justify-start py-[13px] px-6 min-w-[173px] max-w-full border-r-[1px] border-solid border-primary-600 border-l-[1px]">
        <div
